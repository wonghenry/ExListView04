...
/**
 * Created by wong on 2015/9/7.
 */
public class four extends ActionBarActivity implements MediaPlayer.OnPreparedListener,
        ...
        MediaPlayer.OnCompletionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.four);
    ...
    public void gobackoutline4(View v)
    {
