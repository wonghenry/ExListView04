...
/**
 * Created by wong on 2015/9/8.
 */
public class twelve extends ActionBarActivity implements MediaPlayer.OnPreparedListener,
        ...
        MediaPlayer.OnCompletionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mbtnplay2=(Button)findViewById(R.id.btnplay12);
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.twelve);
    ...
    public void gobackoutline12(View v)
    {
