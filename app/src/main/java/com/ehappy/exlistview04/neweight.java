 ...
 */
public class neweight extends ActionBarActivity implements MediaPlayer.OnPreparedListener,
        ...
        MediaPlayer.OnCompletionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.neweight);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_NOSENSOR);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        mbtnplay2=(Button)findViewById(R.id.btnplay6);
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.eight);
    ...
    public void gobackoutline8(View v)
    {
