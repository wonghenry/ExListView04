 ...
 */
public class five extends ActionBarActivity implements MediaPlayer.OnPreparedListener,
        ...
        MediaPlayer.OnCompletionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mbtnplay2=(Button)findViewById(R.id.btnplay5);
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.five);
    ...
    public void gobackoutline5(View v)
    {
