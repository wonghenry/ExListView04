...
public class newseven extends ActionBarActivity implements MediaPlayer.OnPreparedListener,
        ...
        MediaPlayer.OnCompletionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.newseven);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_NOSENSOR);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        mbtnplay2=(Button)findViewById(R.id.btnplay7);
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.seven);
    ...
    public void gobackoutline7(View v)
    {
        Intent it = new Intent(this,newoutline.class);
        startActivity(it);
        newseven.this.finish();
    }
