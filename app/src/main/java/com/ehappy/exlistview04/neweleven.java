 ...
 */
public class neweleven extends ActionBarActivity implements MediaPlayer.OnPreparedListener,
        ...
        MediaPlayer.OnCompletionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.neweleven);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_NOSENSOR);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        mbtnplay2=(Button)findViewById(R.id.btnplay6);
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.eleven);
    ...
    public void gobackoutline11(View v)
    {
        Intent it = new Intent(this,newoutline.class);
        startActivity(it);
        neweleven.this.finish();
    }
