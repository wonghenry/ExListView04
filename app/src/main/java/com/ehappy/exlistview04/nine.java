 ...
 */
public class nine extends ActionBarActivity implements MediaPlayer.OnPreparedListener,
        ...
        MediaPlayer.OnCompletionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.nine);
    ...
    public void gobackoutline9(View v)
    {
