 ...
 */
public class ten extends ActionBarActivity implements MediaPlayer.OnPreparedListener,
        ...
        MediaPlayer.OnCompletionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.ten);
    ...
    public void gobackoutline10(View v)
    {
